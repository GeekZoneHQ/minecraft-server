...
ExecStart=screen -dmS minecraft java -server -Xms512M -Xmx2048M -XX:+UseG1GC -Dcom.mojang.eula.agree=true -jar /opt/minecraft-server/spigot-1.16.3.jar nogui --world-dir /opt/geekzone-world/
